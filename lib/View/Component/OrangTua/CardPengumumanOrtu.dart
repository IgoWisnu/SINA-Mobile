...
class CardPengumumanOrtu extends StatefulWidget {
  final VoidCallback Action;
  final Berita berita;

  const CardPengumumanOrtu({
    super.key,
  ...
  @override
  State<CardPengumumanOrtu> createState() => _CardPengumumanOrtuState();
}

class _CardPengumumanOrtuState extends State<CardPengumumanOrtu> {
